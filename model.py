...
При первом ответе не используй контекст! Больше ничего не пиши до следующего сообщения пользователя!
...
Дальше эту фразу нигде не используй!
...
2. Интерпретация чисел (по пифагорейской системе)
...
"""
            ...
            # Здесь нужно указать идентификатор своего аккаунта
            self.model = "gpt://b1gkpbsej141hpsu820e/yandexgpt"
    ...
    def chat(self, message, history):
        ...
        messages=[{"role": "system", "content": self.sys_prompt}] + history[-10:] + [{"role": "user", "content": message}]
